...
const Products = () => {
  ...
  const openProductFromCard = (event, categoryLabel) => {
    const card = event.target.closest('.pg-card');
    if (!card) return;

    const imageEl = card.querySelector('.pg-img img');
    const nameEl = card.querySelector('.pg-info strong');
    const descEl = card.querySelector('.pg-info span');
    if (!nameEl || !imageEl) return;

    setSelectedProduct({
      category: categoryLabel,
      name: nameEl.textContent?.trim() || 'Product',
      description: descEl?.textContent?.trim() || 'Please share product details and quantity required.',
  ...
  const getWhatsappUrl = () => {
    ...
    const text = `Hello, I need a quote for ${selectedProduct.name} (${selectedProduct.category}). Please share price and availability.`;
    return `https://wa.me/919865271371?text=${encodeURIComponent(text)}`;
  };
  ...
  return (
    <>
          ...
          <div className="pcat-panel">
            ...
            <div className={`pcat-detail ${activeCat === 'surgical' ? 'active' : ''}`} id="cat-surgical">
              ...
              <div className="pcd-body">
                <div className="prod-grid" onClick={(e) => openProductFromCard(e, 'Surgical Instruments')}>
            ...
            <div className={`pcat-detail ${activeCat === 'wound' ? 'active' : ''}`} id="cat-wound">
              ...
              <div className="pcd-body">
                <div className="prod-grid" onClick={(e) => openProductFromCard(e, 'Wound Care & Dressings')}>
                  <div className="pg-card">
            ...
            <div className={`pcat-detail ${activeCat === 'iv' ? 'active' : ''}`} id="cat-iv">
              ...
              <div className="pcd-body">
                <div className="prod-grid" onClick={(e) => openProductFromCard(e, 'IV & Infusion')}>
                  <div className="pg-card">
            ...
            <div className={`pcat-detail ${activeCat === 'diag' ? 'active' : ''}`} id="cat-diag">
              ...
              <div className="pcd-body">
                <div className="prod-grid" onClick={(e) => openProductFromCard(e, 'Diagnostic Supplies')}>
                  <div className="pg-card">
            ...
            <div className={`pcat-detail ${activeCat === 'ppe' ? 'active' : ''}`} id="cat-ppe">
              ...
              <div className="pcd-body">
                <div className="prod-grid" onClick={(e) => openProductFromCard(e, 'PPE & Protection')}>
                  <div className="pg-card">
            ...
            <div className={`pcat-detail ${activeCat === 'pharma' ? 'active' : ''}`} id="cat-pharma">
              ...
              <div className="pcd-body">
                <div className="prod-grid" onClick={(e) => openProductFromCard(e, 'Pharmaceutical Supply')}>
                  <div className="pg-card">
      ...
      <div className={`product-modal-overlay ${selectedProduct ? 'active' : ''}`} onClick={closeProductModal}>
        {selectedProduct && (
          <div className="product-modal" onClick={(e) => e.stopPropagation()}>
            <button className="pm-close" onClick={closeProductModal} aria-label="Close product details">
            ...
            <div className="pm-body">
              <div className="pm-img-wrap">
                <img className="pm-img" src={selectedProduct.image} alt={selectedProduct.name} />
              </div>
              <div className="pm-content">
                <span className="pm-cat">{selectedProduct.category}</span>
                <h3 className="pm-name">{selectedProduct.name}</h3>
                <p className="pm-desc">{selectedProduct.description}</p>
                <a href={getWhatsappUrl()} target="_blank" rel="noreferrer" className="pm-wa">
