      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Reveal animation="reveal-up">
          <div className="overflow-hidden rounded-[2rem] shadow-2xl bg-[#ffffff] border border-[#e3e2e7]">
            ...
            {/* Main Bento Content */}
            <main className="p-6 md:p-12 lg:p-16 relative bg-[#ffffff]">
              {/* Branding Section */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 md:items-start gap-12">
                ...
                <div className="md:col-span-7 flex flex-col gap-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div className="flex flex-col gap-4 group">
                      <div className="w-14 h-14 flex items-center justify-center bg-[#e8e7ed] rounded-2xl group-hover:bg-[#00193c] transition-colors duration-300">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7 text-[#00193c] group-hover:text-white transition-colors">
                  ...
                  {/* ══ ZONE 1: Stats Row ══ */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-[#e3e2e7] rounded-2xl overflow-hidden">
                    <div className="flex flex-col items-center justify-center py-6 px-4 text-center border-b md:border-b-0 md:border-r border-[#e3e2e7]">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-[#00193c] mb-2">
