...
export default function ProductsPage() {
  ...
  const products = productsByCat[activeCat] || [];

  const handleCardClick = (product) => {
    setSelectedProduct({ ...product, category: currentCat?.label || activeCat });
  };
    ...
    <>
      ...
      <div className="pp-hero">
        ...
        <div className="pp-hero-content">
          <span className="pp-hero-tag">Our Products</span>
        ...
        <main className="pp-main" id="pp-main">
          ...
          <div className="pp-panel-head">
            <div className="pp-panel-head-img">
              <img src={assetUrl(currentCat?.banner || '')} alt={currentCat?.label} />
          ...
          <div className="pp-cat-wa-wrap">
            <a
              ...
              href={`https://wa.me/919865271371?text=${encodeURIComponent(
                `Hello, I need a quote for ${currentCat?.label}. Please share price and availability.`
              )}`}
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              Enquire on WhatsApp for {currentCat?.label}
            </a>
          </div>
        </main>
      </div>
