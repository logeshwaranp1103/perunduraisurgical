...
const Contact = () => {
  ...
  const sendWA = () => {
    ...
    const text = `Hello Thiyash Enterprise!%0A%0AName: ${encodeURIComponent(name || 'Not provided')}%0APhone: ${encodeURIComponent(phone || 'Not provided')}%0ACategory: ${encodeURIComponent(category || 'Not specified')}%0AMessage: ${encodeURIComponent(message || 'Not specified')}`;
  ...
  const sendEmail = () => {
    ...
    window.location.href = 'mailto:perunduraihousekeepings@gmail.com?subject=' + subject + '&body=' + body;
  };
  ...
  return (
    <section id="contact" className="section alt" style={{ paddingTop: '30px' }}>
      ...
      <Reveal className="section-visual contact" animation="reveal-up" delay="0.05s">
        <img
          src="https://images.unsplash.com/photo-1534536281715-e28d76689b4d?w=1400&q=85&auto=format&fit=crop"
          alt="cleaning customer support and consultation desk"
          loading="lazy"
        />
      </Reveal>
      <Reveal id="contact-form" className="contact-wrap" animation="reveal-up">
        <div className="contact-left">
          ...
          <p>We supply to offices, clinics, nursing homes, and retail pharmacies. Reach us on any channel — we're here to help.</p>
