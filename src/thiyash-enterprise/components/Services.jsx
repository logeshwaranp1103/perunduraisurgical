  ...
  return (
    <section id="services" className="section alt" style={{ paddingTop: '30px' }}>
      <Reveal className="s-head" animation="reveal-up">
        ...
        <p className="s-sub">Comprehensive services designed for facility management facilities of every size.</p>
      </Reveal>
      <Reveal className="section-visual" animation="reveal-up" delay="0.05s">
        <img
          ...
          alt="facility management logistics and cleaning supply operations"
          loading="lazy"
        />
      </Reveal>
      <div className="svc-grid">
        <Reveal className="svc-card" animation="reveal-up">
          ...
          <div className="svc-content">
            <h3>Wholesale Cleaning Supply</h3>
            <p>Bulk orders with competitive pricing for offices, clinics, nursing homes, and pharmacies across Tamil Nadu.</p>
          </div>
        </Reveal>
        <Reveal className="svc-card" animation="reveal-up" delay="0.1s">
          ...
          <div className="svc-content">
            ...
            <p>Fast and reliable dispatch for urgent cleaning requirements. Same-day delivery available for local orders.</p>
          </div>
        </Reveal>
        <Reveal className="svc-card" animation="reveal-up" delay="0.2s">
          ...
          <div className="svc-content">
            ...
            <p>Expert guidance on selecting the right housekeeping and pharmaceutical products for your specific clinical needs.</p>
          </div>
        </Reveal>
