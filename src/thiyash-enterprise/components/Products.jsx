...
const Products = () => {
  ...
  // Clicking any product card navigates to the /enterprise/products page
  const handleCardClick = (e) => {
    if (e.target.closest('.pg-card')) navigate('/enterprise/products');
  };
    ...
    <>
      <section id="products" className="section">
        <Reveal className="s-head">
          ...
          <h2 className="s-title">Comprehensive <em>Housekeeping Supply</em> Range</h2>
