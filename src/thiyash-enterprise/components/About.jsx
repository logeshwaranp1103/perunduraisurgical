    ...
    <section id="about" className="section alt">
      <div className="about-grid">
        ...
        <Reveal animation="reveal-right">
          ...
          <p className="s-sub">Thiyash Enterprise is a leading wholesale distributor of housekeeping and pharmaceutical products, proudly based in Perundurai, Erode District, Tamil Nadu. We specialize in supplying medicines, housekeeping equipments, disposables, cleaning consumables, and hospital supplies to government offices, private offices, clinics, nursing homes, and retail pharmacies across the region. Every product in our inventory is sourced from licensed, government-approved manufacturers, ensuring genuine quality and full regulatory compliance with Central Drugs Standard Control Organization ( CDSCO ) and Tamil Nadu Drug Control Department guidelines. At Thiyash Enterprise, we are committed to delivering the right product at the right time, with competitive pricing and reliable service, making us a trusted partner in the regional facility management supply chain.</p>
