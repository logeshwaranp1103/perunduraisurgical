...
const Footer = () => {
  ...
  const handleBackToTop = (e) => {
    // If we are on the main enterprise page, just scroll to top using the majestic animation
    if (location.pathname === '/enterprise') {
      if (e) e.preventDefault();
      scrollToId(e, 'home-strip');
    }
    // Else let <Link> handle navigation if it's "Back to home"
  };
          ...
          <div className="footer-grid">
            <Reveal className="fg-about" animation="reveal-left">
              ...
              <div className="foot-social visible">
                ...
                <a href="mailto:thiyashenterprise@gmail.com" title="Email">
            ...
            <Reveal className="fg-col" animation="reveal-right" delay="0.3s">
              ...
              <div className="foot-ci">
                ...
                <a href="mailto:perunduraihousekeepings@gmail.com">perunduraihousekeepings@gmail.com</a>
              </div>
            </Reveal>
          </div>
          <div className="footer-bottom">
            <p>© 2026 Thiyash Enterprise. All rights reserved. | Proprietor: K. Ragavendran B.E.</p>
            <Link 
              to={isProductsPage ? "/enterprise" : "#"} 
