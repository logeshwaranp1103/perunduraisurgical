    ...
    <section id="hero" ref={heroRef}>
      ...
      <div className="hero-inner">
        <Reveal className="hero-col-left" animation="reveal-up">
          <div className="hero-badge visible">Verified Wholesale Cleaning Supply</div>
          <h1 className="hero-title-line visible" style={{ transitionDelay: '0.1s'}}>Your Trusted Partner</h1>
          <h1 className="hero-title-line visible" style={{ marginTop: '-15px', transitionDelay: '0.2s' }}><span style={{color: '#E5E7EB'}}>for</span> <em style={{ color: '#F59E0B' }}>Housekeeping & Cleaning</em></h1>
          <p className="hero-sub visible" style={{ transitionDelay: '0.3s', color: '#D1D5DB', fontSize: '20px'}}>
            Thiyash Enterprise supplies hotels, hospitals, corporate offices, and commercial facilities across Erode, Tirupur, Salem, Coimbatore, and Namakkal districts with premium housekeeping materials and tools at the most competitive wholesale prices.
          </p>
